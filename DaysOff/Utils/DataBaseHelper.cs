...
namespace DaysOff.Utils
{
    public class DataBaseHelper
    {
            ...
            public static List<IUserBase> getActiveTLPs(DateTime startCheck, DateTime endCheck, DayOff.Data.DayOffContext context)
        {
            ...
            {
                userBase.HolidaysTaken = getNoHolidaysTaken(userBase,context);
                usersBase.Add(userBase);
            }
            return usersBase;
        }

        public static float getNoHolidaysTaken(IUserBase userBase, DayOffContext context) {
            List<Holiday> holidays;
            ...
            return (float)holidays.Count() / 2;

        }
        public static List<IUserBase> getActiveUsers(DateTime startCheck, DateTime endCheck, DayOffContext context)
        {
            List<UserBase> userQuery = new List<UserBase>();
